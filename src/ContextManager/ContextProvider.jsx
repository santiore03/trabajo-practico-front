...
const ContextProvider = ({ children }) => {
  const products = [
    {
      ...
      stock: 10,
      descripcion:
        'Celular. Pantalla 6.4" Dynamic AMOLED 2X. Procesador: Octa core. Resolucion: 2340 x 1080 FHD+. Camara: 50.0 MP + 10.0 MP + 12.0 MP. Frontal: 10 MP. Sistema operativo Android. Almacemamiento: 256 Gb. RAM: 8 Gb. Video 4k. WIFI. USB. NFC. GPS. Navegador Chrome. Bateria: 4500 mAh. Bluetooth.',
    ...
    },
    {
      ...
      stock: 5,
      descripcion:
        'Celular. Pantalla Super AMOLED de 6.5". Procesador: Octa-Core 2.8GHz, 2.4GHz, 1.8GHz. Bateria: 4,500mAh / 25W Fast Charging. Camara: 12.0 MP + 12.0 MP + 8.0 MP. Camara Frontal: 32.0 MP. Optical Zoom at 3x , Digital Zoom up to 30x. NFC. USB. WIFI. Micro SD. Bluetooth. Almacenamiento: 128 Gb. RAM: 6 Gb. 5G. FOD. Galaxy Experience. IP68. Sensores: Acelerometro / Sensor de huellas dactilares / Sensor giroscopico / Sensor geomagnetico / Sensor Hall / Sensor de luz RGB / Deteccion de proximidad virtual.',
      categoria: "CEL PHONES",
  ...
  const handleRegisterUser = (evento) => {
    ...
    setFormUserData({ nombre: "", email: "", mensaje: "" });
  };
